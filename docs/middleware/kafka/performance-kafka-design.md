...
> 宏观架构层面利用Partition实现并行处理，因为kafka的基本调度单位是partition。
...
![kafka-consumer.png](/images/kafka-consumer.png)
...
![kafka-replication111.png](/images/kafka-replication111.png)
...
![kafka-BIO.png](/images/kafka-BIO.png)
...
![kafka-NIO.png](/images/kafka-NIO.png)
